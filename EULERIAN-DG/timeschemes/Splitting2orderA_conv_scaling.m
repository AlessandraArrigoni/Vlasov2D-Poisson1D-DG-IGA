function [filenames] = Splitting2orderA_conv_scaling(Data)
       ...
       % PERMUTE MATRICES TO ALLOW FASTER COMPUTATIONS
        ...
        for dt_scaling = Data.scalings % Loop over dt_scalings
            ...
            for t = 0 : dt : Data.Tend-dt % Time loop
                ...
                % Save intermediate solutions to both problems for the current
                % dt_scaling. They are stored in a struct
