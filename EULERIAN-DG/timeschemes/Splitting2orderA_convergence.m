function [filenames] = Splitting2orderA_convergence(Data)
...
% values at the final time. 
    ...
    for ref = Data.nref % Loop over refinements
        ...
        source0 = source_rhs_given_f(femregion, @(x,y) Data.source(x,y,0),basis);
        ...
        for t = 0 : dt : Data.Tend-dt % Time loop
            ...
            source05 = source_rhs_given_f(femregion, @(x,y) Data.source(x,y,t+0.5*dt),basis);
            source1 = source_rhs_given_f(femregion, @(x,y) Data.source(x,y,t+dt),basis);
        
            % STEP 1: advection in x (beta = [v, 0]), WITH source term
            fprintf('\n--------STEP 1 for t = %d \n',t); 
            rhs1 = (M_dg - 0.25*dt*Lv)*f_old + 0.25*dt*(source0 + source05);
            ...
            % STEP 3: advection in x (beta = [v, 0], WITH source term
            fprintf('--------STEP 3 for t = %d \n',t); 
            rhs3 = (M_dg - 0.25*dt*Lv)*f_half + 0.25*dt*(source1 + source05);
