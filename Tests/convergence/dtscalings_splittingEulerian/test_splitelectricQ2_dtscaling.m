...
% Q2
subplot(1,3,1); 
loglog(hh, 200*hh.^(femregion.degree + 1),'k--','LineWidth',1); 
leg1{i+1} = ['$O(h^' num2str(femregion.degree+1) ')$'];
legend(leg1,'Interpreter','latex','Location','NW','FontSize',14); xlabel('h','FontSize',14); 
ylabel('$\| f- f_h\|_{L^2} \, / \, \|f\|_{L^2}$','Interpreter','latex','FontSize',12);

subplot(1,3,2); 
loglog(hh, 3*hh.^(femregion.degree),'k-.','LineWidth',1); 
...
legend(leg2,'Interpreter','latex','Location','NW','FontSize',14); xlabel('h','FontSize',14); 
...
legend(leg3,'Interpreter','latex', 'Location','NW','FontSize',14); xlabel('h','FontSize',14); 
